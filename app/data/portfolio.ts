...
export const projects = [
  {
    id: 1,
    name: "GeoPulse",
    description: "Geopolitics intelligence platform aggregating the latest global news, major historical world events, country timelines, and geopolitical analytics — all in one place.",
    techStack: ["Spring Boot", "Next.js", "TypeScript", "Java", "PostgreSQL"],
    githubRepo: "saeedsbr/geopulse-frontend",
    liveUrl: null,
  ...
  },
  {
    ...
    description: "Personal habit & daily goal tracking app — set and track routines like early rising, exercise, and daily targets. Build better habits one day at a time.",
    techStack: ["Next.js", "TypeScript", "Spring Boot", "MySQL", "Tailwind CSS"],
    githubRepo: "saeedsbr/activity-tracker-next-js",
    liveUrl: null,
  ...
  },
  {
    ...
    description: "University hostel administration platform built with Next.js + TypeScript — streamlining student accommodation, room allocation, and campus hostel operations.",
    techStack: ["Next.js", "TypeScript", "PostgreSQL", "Tailwind CSS"],
    githubRepo: "saeedsbr/Hostel-management-ssytem-nextjs",
    liveUrl: null,
    difficulty: "Intermediate" as const,
    featured: false,
    lastCommit: "2mo ago",
  ...
  },
  {
    id: 6,
    name: "Family App",
    description: "Spring Boot backend for a family management application — REST APIs for managing family members, relationships, and shared activities with clean layered architecture.",
